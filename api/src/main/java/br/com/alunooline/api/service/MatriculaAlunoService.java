...
import br.com.alunooline.api.model.MatriculaAluno;
import br.com.alunooline.api.repository.MatriculaAlunoRepository;
import br.com.alunooline.api.dto.AtualizarNotasRequestDTO;
import br.com.alunooline.api.dto.DisciplinasAlunoResponseDTO;
import br.com.alunooline.api.dto.HistoricoAlunoResponseDTO;
...
public class MatriculaAlunoService {
    ...
    public void atualizarNotas(AtualizarNotasRequestDTO request, Long idMatricula){
        ...
        if (request.getNota1() != Double.parseDouble(null)) {
            matriculaAluno.setNota1(request.getNota1());
        }

        if (request.getNota2() != Double.parseDouble(null)) {
    ...
    public HistoricoAlunoResponseDTO emitirHistorico(Long idAluno){
        ...
        historicoAluno.setMatriculaAluno(matriculasDoAluno.get(0).getAluno().getCpfAluno());
